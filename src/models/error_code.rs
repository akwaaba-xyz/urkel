...
impl ToString for ErrorCode {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::AuthorizationModelResolutionTooComplex => String::from("authorization_model_resolution_too_complex"),
            Self::InvalidWriteInput => String::from("invalid_write_input"),
            Self::CannotAllowDuplicateTuplesInOneRequest => String::from("cannot_allow_duplicate_tuples_in_one_request"),
            Self::CannotAllowDuplicateTypesInOneRequest => String::from("cannot_allow_duplicate_types_in_one_request"),
            Self::CannotAllowMultipleReferencesToOneRelation => String::from("cannot_allow_multiple_references_to_one_relation"),
            ...
            Self::AuthorizationModelAssertionsNotFound => String::from("authorization_model_assertions_not_found"),
            Self::LatestAuthorizationModelNotFound => String::from("latest_authorization_model_not_found"),
            ...
            Self::TupleKeysTooManyOrTooFewItems => String::from("tuple_keys_too_many_or_too_few_items"),
            ...
            Self::QueryStringTypeContinuationTokenMismatch => String::from("query_string_type_continuation_token_mismatch"),
