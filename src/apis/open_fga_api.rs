...
pub async fn check(configuration: &configuration::Configuration, store_id: &str, body: crate::models::CheckRequest) -> Result<crate::models::CheckResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/check", configuration.base_path, store_id=crate::apis::urlencode(store_id));
...
pub async fn create_store(configuration: &configuration::Configuration, body: crate::models::CreateStoreRequest) -> Result<crate::models::CreateStoreResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;
...
pub async fn delete_store(configuration: &configuration::Configuration, store_id: &str) -> Result<(), Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}", configuration.base_path, store_id=crate::apis::urlencode(store_id));
...
pub async fn expand(configuration: &configuration::Configuration, store_id: &str, body: crate::models::ExpandRequest) -> Result<crate::models::ExpandResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/expand", configuration.base_path, store_id=crate::apis::urlencode(store_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn get_store(configuration: &configuration::Configuration, store_id: &str) -> Result<crate::models::GetStoreResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;
...
pub async fn list_objects(configuration: &configuration::Configuration, store_id: &str, body: crate::models::ListObjectsRequest) -> Result<crate::models::ListObjectsResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/list-objects", configuration.base_path, store_id=crate::apis::urlencode(store_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn list_stores(configuration: &configuration::Configuration, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<crate::models::ListStoresResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;
...
pub async fn read(configuration: &configuration::Configuration, store_id: &str, body: crate::models::ReadRequest) -> Result<crate::models::ReadResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/read", configuration.base_path, store_id=crate::apis::urlencode(store_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn read_assertions(configuration: &configuration::Configuration, store_id: &str, authorization_model_id: &str) -> Result<crate::models::ReadAssertionsResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/assertions/{authorization_model_id}", configuration.base_path, store_id=crate::apis::urlencode(store_id), authorization_model_id=crate::apis::urlencode(authorization_model_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn read_authorization_model(configuration: &configuration::Configuration, store_id: &str, id: &str) -> Result<crate::models::ReadAuthorizationModelResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/authorization-models/{id}", configuration.base_path, store_id=crate::apis::urlencode(store_id), id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn read_authorization_models(configuration: &configuration::Configuration, store_id: &str, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<crate::models::ReadAuthorizationModelsResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/authorization-models", configuration.base_path, store_id=crate::apis::urlencode(store_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn read_changes(configuration: &configuration::Configuration, store_id: &str, r#type: Option<&str>, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<crate::models::ReadChangesResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/changes", configuration.base_path, store_id=crate::apis::urlencode(store_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn update_store(configuration: &configuration::Configuration, store_id: &str, body: crate::models::UpdateStoreRequest) -> Result<crate::models::UpdateStoreResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;
...
pub async fn write(configuration: &configuration::Configuration, store_id: &str, body: crate::models::WriteRequest) -> Result<serde_json::Value, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/stores/{store_id}/write", configuration.base_path, store_id=crate::apis::urlencode(store_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn write_assertions(configuration: &configuration::Configuration, store_id: &str, authorization_model_id: &str, body: crate::models::WriteAssertionsRequest) -> Result<(), Error<OpenFGAError>> {
    let local_var_client = &configuration.client;
...
pub async fn write_authorization_model(configuration: &configuration::Configuration, store_id: &str, body: crate::models::WriteAuthorizationModelRequest) -> Result<crate::models::WriteAuthorizationModelResponse, Error<OpenFGAError>> {
    let local_var_client = &configuration.client;
