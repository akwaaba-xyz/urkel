...
async fn list_stores(page_size: Option<i32>, continuation_token: Option<&str>) -> Result<status::Custom<Json<urkel::models::ListStoresResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
            ...
            Err(error) => {
                match error {
                    ...
                    _ => {
                        ...
                        let error_wrapper = urkel::apis::open_fga_api::OpenFGAError::Status500(internal_error);
...
async fn create_store(body: Json<urkel::models::CreateStoreRequest>) -> Result<status::Custom<Json<urkel::models::CreateStoreResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
async fn get_store(store_id: &str) -> Result<status::Custom<Json<urkel::models::GetStoreResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
async fn delete_store(store_id: &str) -> Result<status::Custom<()>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::delete_store(&config, store_id)
        .await {
...
#[get("/stores/<store_id>/authorization-models?<page_size>&<continuation_token>", format = "json")]
async fn list_models(store_id: &str, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<status::Custom<Json<urkel::models::ReadAuthorizationModelsResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
#[post("/stores/<store_id>/authorization-models", format = "json", data = "<body>")]
async fn create_model(store_id: &str, body: Json<urkel::models::WriteAuthorizationModelRequest>) -> Result<status::Custom<Json<urkel::models::WriteAuthorizationModelResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
async fn get_model(store_id: &str, id: &str) -> Result<status::Custom<Json<urkel::models::ReadAuthorizationModelResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
#[get("/stores/<store_id>/changes?<type>&<page_size>&<continuation_token>", format = "json")]
async fn list_changes(store_id: &str, r#type: Option<&str>, page_size: Option<i32>, continuation_token: Option<&str>) -> Result<status::Custom<Json<urkel::models::ReadChangesResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
async fn read(store_id: &str, body: Json<urkel::models::ReadRequest>) -> Result<status::Custom<Json<urkel::models::ReadResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::read(&config, store_id, body.into_inner())
        .await {
            Ok(result) => Ok(status::Custom(Status::Ok, Json(result))),
            Err(error) => {
                match error {
...
async fn write(store_id: &str, body: Json<urkel::models::WriteRequest>) -> Result<status::Custom<Json<serde_json::Value>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::write(&config, store_id, body.into_inner())
        .await {
            Ok(result) => Ok(status::Custom(Status::Ok, Json(result))),
            Err(error) => {
                match error {
...
async fn check(store_id: &str, body: Json<urkel::models::CheckRequest>) -> Result<status::Custom<Json<urkel::models::CheckResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::check(&config, store_id, body.into_inner())
        .await {
            Ok(result) => Ok(status::Custom(Status::Ok, Json(result))),
            Err(error) => {
                match error {
...
async fn expand(store_id: &str, body: Json<urkel::models::ExpandRequest>) -> Result<status::Custom<Json<urkel::models::ExpandResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::expand(&config, store_id, body.into_inner())
        .await {
            Ok(result) => Ok(status::Custom(Status::Ok, Json(result))),
            Err(error) => {
                match error {
...
async fn list_objects(store_id: &str, body: Json<urkel::models::ListObjectsRequest>) -> Result<status::Custom<Json<urkel::models::ListObjectsResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::list_objects(&config, store_id, body.into_inner())
        .await {
            Ok(result) => Ok(status::Custom(Status::Ok, Json(result))),
            Err(error) => {
                match error {
...
#[get("/stores/<store_id>/assertions/<authorization_model_id>", format = "json")]
async fn list_assertions(store_id: &str, authorization_model_id: &str) -> Result<status::Custom<Json<urkel::models::ReadAssertionsResponse>>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
...
#[put("/stores/<store_id>/assertions/<authorization_model_id>", format = "json", data = "<body>")]
async fn create_assertions(store_id: &str, authorization_model_id: &str, body: Json<urkel::models::WriteAssertionsRequest>) -> Result<status::Custom<()>, status::Custom<Json<urkel::apis::open_fga_api::OpenFGAError>>> {
    let config = Configuration::new();
    match urkel::apis::open_fga_api::write_assertions(&config, store_id, authorization_model_id, body.into_inner())
        .await {
            Ok(_) => Ok(status::Custom(Status::Ok, () )),
            Err(error) => {
                match error {
...
fn unprocessable_entity() -> Json<urkel::models::ValidationErrorMessageResponse> {
    let validation_error = urkel::models::ValidationErrorMessageResponse {
        ...
        message: Some("The request was well-formed but was unable to be followed due to semantic errors.".to_string())
    };
